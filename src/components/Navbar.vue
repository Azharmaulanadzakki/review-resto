<template>
	<nav class="fixed z-50 w-[90%] mx-[5%] p-6 top-6 flex justify-between items-center bg-gray-300 bg-opacity-40 backdrop-blur-xl rounded-3xl">
		<a class="text-3xl font-['Poppins'] font-bold text-transparent bg-clip-text bg-gradient-to-br from-gray-900 to-gray-500" href="#">
      Review Resto
		</a>
		<div class="lg:hidden">
		...
		<ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
			<li><a class="text-sm text-gray-500 hover:text-gray-900 font-['Poppins']" href="/">Home</a></li>
			<li class="text-gray-300">
			</li>
			<li><a class="text-sm text-indigo-600 font-bold font-['Poppins']" href="/restos">Reviews</a></li>
			<li class="text-gray-300">
			</li>
			<li><a class="text-sm text-gray-500 hover:text-gray-900 font-['Poppins']" href="#">Services</a></li>
			<li class="text-gray-300">
			</li>
			<li><a class="text-sm text-gray-500 hover:text-gray-900 font-['Poppins']" href="#">Pricing</a></li>
			<li class="text-gray-300">
			</li>
		</ul>
